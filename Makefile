...
ARMA_DIR=/usr/local/pkg/armadillo
...
ARMA_Include=-I$(ARMA_DIR)/include
...
test: test.o folding.o folding_helper.o drag.o dcollid3d.o dcollid.o spring_solver.o drag_proto.o ex_spring_solver.o im_spring_solver.o bending.o cgal.o origami.o
	$(CXX) $^ -lFronTier -lm -o test $(libincs) $(libs) $(CGAL_Lib) $(CVODE_Lib) $(NLOPT_Lib) $(ARMA_Lib) -lgmp -lmpfr -frounding-math
...
origami.o: origami.cpp
	$(CXX) $< -c $(incs) $(NLOPT_Include) $(ARMA_Include)
%.o: %.cpp
